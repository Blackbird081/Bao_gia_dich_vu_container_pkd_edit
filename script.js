// Tắt kiểm tra TypeScript cho file này và khai báo các thư viện toàn cục
// @ts-nocheck
/* global flatpickr, XLSX, html2canvas, jspdf */

// [CẢI TIẾN] Bọc toàn bộ code trong một IIFE để tránh làm ô nhiễm global scope
(function() {
    'use strict';

    // --- 1. STATE & CONFIG ---
    const staticQrCode = "data:image/jpeg;base64,";
    ...
    const i18n = {
        ...
        pdf: {
            ...
            containerQtyDetail: { vi: '(SL: {containerQty} cont x {days} ngày)', en: '({containerQty} cont x {days} days)' },
            ...
            ,
            powerQtyDetail: { vi: '(SL: {containerQty} cont x {hours} giờ)', en: '({containerQty} cont x {hours} hrs)' }
        }
    };
        ...
        row.innerHTML = `
            <td class="px-4 py-2 align-top">
                ...
                <div class="calculation-picker container-qty-picker">
                    ...
                    <input type="number" class="container-qty-input mt-1 block w-full rounded-md border-gray-300 shadow-sm sm:text-sm" value="1" min="1" step="1">
                </div>
    ...
    function recalculateTotals() {
        ...
        document.querySelectorAll('.item-row').forEach(row => {
            ...
            const serviceName = row.querySelector('.product-select').value;
            // [CẬP NHẬT] Kiểm tra xem có phải là dịch vụ cắm điện không
            const isStorageService = serviceName.toLowerCase().includes(i18n.storageKeywords[state.currentLang]);
            const isPowerService = serviceName.toLowerCase().includes(i18n.powerKeywords[state.currentLang]);
            
            let lineTotal = 0;
            // [CẬP NHẬT] Áp dụng công thức nhân số lượng container cho cả dịch vụ lưu bãi và cắm điện
            if ((isStorageService || isPowerService) && serviceName) {
                const containerQty = parseFloat(row.querySelector('.container-qty-input').value) || 1;
                const timeQty = parseFloat(row.querySelector('.qty-input').value) || 0;
                lineTotal = containerQty * timeQty * price;
            } else {
    ...
    function resetForm(confirmNeeded = true) { 
        const doReset = () => {
            elements.customerName.value = ''; elements.customerTaxCode.value = ''; elements.customerAddress.value = ''; elements.customerPhone.value = ''; elements.customerNotes.value = '';
    ...
    function saveQuotation() {
        ...
        const newQuotation = {
            ...
            items: Array.from(elements.tableBody.querySelectorAll('.item-row')).map(row => ({
                ...
                containerQty: row.querySelector('.container-qty-input').value
    ...
    function loadQuotation(id) { 
        ...
        q.items.forEach(item => { 
            ...
            if (item.containerQty) {
                lastRow.querySelector('.container-qty-input').value = item.containerQty;
            }
    ...
    function generateA4HTML(qrCodeBase64) {
        const itemsHTML = Array.from(document.querySelectorAll('.item-row')).map((row, index) => {
            ...
            let displayName = productName === i18n.otherOption[state.currentLang] ? `${productName} ${i18n.pdf.otherOptionNote[state.currentLang]}` : productName;
            const isStorageService = productName.toLowerCase().includes(i18n.storageKeywords[state.currentLang]);
            const isPowerService = productName.toLowerCase().includes(i18n.powerKeywords[state.currentLang]);

            if (isStorageService) {
                const containerQty = row.querySelector('.container-qty-input').value;
                const days = row.querySelector('.qty-input').value;
                const detailText = i18n.pdf.containerQtyDetail[state.currentLang]
                    .replace('{containerQty}', containerQty)
                    .replace('{days}', days);
                displayName += ` ${detailText}`;
            } else if (isPowerService) { // [CẬP NHẬT] Thêm logic hiển thị chi tiết cho dịch vụ cắm điện
                const containerQty = row.querySelector('.container-qty-input').value;
                const hours = row.querySelector('.qty-input').value;
                const detailText = i18n.pdf.powerQtyDetail[state.currentLang]
                    .replace('{containerQty}', containerQty)
                    .replace('{hours}', hours);
                displayName += ` ${detailText}`;
            }
    ...
    function handleTableRowChange(e) {
        if (e.target.classList.contains('product-select')) {
            ...
            const containerQtyPicker = row.querySelector('.container-qty-picker');
            ...
            // [CẬP NHẬT] Hiển thị ô số lượng container cho cả dịch vụ lưu bãi và cắm điện
            containerQtyPicker.classList.toggle('visible', isStorageService || isPowerService);
